...
public class DynamicBeat extends JFrame{
	...
	private ImageIcon exitButtonEnterdIcon = new ImageIcon(Main.class.getResource("../images/exitButtonEntered.png"));
	private ImageIcon exitButtonBasicIcon = new ImageIcon(Main.class.getResource("../images/exitButtonBasic.png"));
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("Mighty Love Title.png", "Mighty Start Image.jpg", "Mighty Game Image.jpg", "Mighty Love Selected.mp3", "Mighty Love.mp3"));
		trackList.add(new Track("Wild Flower Title Image.png", "Wild Flower Start Image.jpg", "Wild Flower Game Image.jpg", "Wild Flower Selected.mp3", "JOAKIM KARUD - WILD FLOWER (FREE MUSIC FOR VLOGS).mp3"));
		trackList.add(new Track("Energy Title Image.png", "Energy Start Image.jpg", "Energy Game Image.jpg", "Energy Selected.mp3", "Energy.mp3"));
		...
		exitButton.addMouseListener(new MouseAdapter() { 
			...
			public void mouseEntered(MouseEvent e) {
				exitButton.setIcon(exitButtonEnterdIcon);
	...
	public void screenDraw(Graphics2D g) {
		...
		if(isGameScreen)
		{
			...
			g.drawImage(noteBasicImage, 744, 320, null);
